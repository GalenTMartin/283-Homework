...
ref="/pub/galentm/283/dmel-all-chromosome-r6.25.fasta"

# Option #1 -- traditional GATK pipeline (slow)
java -d64 -jar /data/apps/picard-tools/1.87/MergeSamFiles.jar I=fixed2_A4_1.RG.bam I=fixed2_A4_2.RG.bam I=fixed2_A5_1.RG.bam I=fixed2_A5_2.RG.bam I=fixed2_A5_3.RG.bam I=fixed2_A6_1.RG.bam I=fixed2_A6_2.RG.bam I=fixed2_A6_3.RG.bam I=fixed2_A7_2.RG.bam I=fixed2_A7_3.RG.bam SO=coordinate AS=true VALIDATION_STRINGENCY=SILENT O=merged.bam
